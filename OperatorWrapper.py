...
class OperatorStreak():
    def __init__(self, streak=[], value=None):
        self.streak = streak
...
myWrappedInt = MyWrapper(MyInt(3))

print(myWrappedInt <X| 3) # (a+b) * 2 => (3+3)*2 => 6*2 => 12
print(myWrappedInt |X| 4) # (3+4+4) => 11

PLACEHOLDER = X

print(myWrappedInt <PLACEHOLDER| 3) # (a+b) * 2 => (3+3)*2 => 6*2 => 12
